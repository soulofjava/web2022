    ...
    <div class="container">
        <div class="content-box">
            <div class="text-center">
                <button type="button" style="color: white; background: #6377EE;" class="btn" data-toggle="modal"
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        {{ Form::open(['url' => 'guest', 'method' => 'post', '']) }}
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn" style="color: white; background: #6377EE;">Simpan</button>
                        </div>
                        {{ Form::close() }}
                    </div>
                </div>
