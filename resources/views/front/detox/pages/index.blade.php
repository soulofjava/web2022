                ...
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                        <div class="content-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <h1>
                                {!! \Illuminate\Support\Str::limit($hl->title, 45, $end='...') !!}
                            </h1>
                            <div class="btn-box">
                                <a href="{{ url('/news-detail', $hl->slug) }}" class="theme-btn style-one">
                                    Lebih Detail
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="image-box wow slideInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <figure class="image image-1">
                                ...
                                <img loading="lazy"
                                    ...
                                    alt="thumb"
                                    style="width: 600px !important; height: 612px !important; object-fit: cover !important;">
                                @else
