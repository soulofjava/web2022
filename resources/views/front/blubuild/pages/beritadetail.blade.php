                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-lg-8">
                        <div class="post-detail w-100">
                            ...
                            <p class="mb-0">{!! $berita['isi_posting'] !!}</p>
                                ...
                                <div class="about-widget text-center w-100">
                                    <div class="about-widget-img d-inline-block">
                                        ...
                                        <img class="img-fluid rounded-circle"
                                            src="https://ui-avatars.com/api/?name=Admin" alt="Admin">
                                        <!-- <img class="img-fluid rounded-circle"
                                ...
                                <div class="blog-widget-post-list w-100">
                                    ...
                                    <div class="blog-mini-post w-100">
                                        <a href="{{ url('/news-detail', $n->slug) }}">
                                            ...
                                            <img class="img-fluid" src="{{ route('helper.show-picture', ['path' => $n->path]) }}"
                                                alt="{{ $n->title}}">
                                            @else
