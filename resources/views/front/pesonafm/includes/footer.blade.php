<footer>
    <div class="hidden py-6 px-4 bg-red-500 lg:flex md:items-center md:justify-around">
        <div class="flex mt-4 space-x-6 sm:justify-between md:mt-0">
            <a href="https://www.facebook.com/profile.php?id=100039381652233"
                class="text-white hover:text-gray-900 dark:hover:text-gray-900">
            ...
            <a href="https://www.instagram.com/pesonafmwonosobo"
                class="text-white hover:text-gray-900 dark:hover:text-gray-900">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fill-rule="evenodd"
