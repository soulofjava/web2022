        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200" style="display: flex">
                    <div class="post-box">
                        <div class="post-img"
                            style="justify-content: center; align-items: center; display: flex; overflow: hidden; height: 250px !important; width: 416px !important;">
                            @if($n->gambarmuka)
                            <img loading="lazy" src="{{ route('helper.show-picture', ['path' => $n->gambarmuka->path]) }}"
                                class="img-thumbnail" alt="{{ $n->gambarmuka->file_name }}"
                                style="flex-shrink: 0; height: 250px !important; width: 416px !important;">
                            @else
