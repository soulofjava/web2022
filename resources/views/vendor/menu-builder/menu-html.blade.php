                            ...
                            <div class="manage-menus">
                                ...
                                <form method="get" action="{{ $currentUrl }}">
                                    ...
                                    <span class="add-new-menu-action"> @lang("menu-builder::messages.or") <a
                                            href="{{ $currentUrl }}?action=edit&menu=0">@lang("menu-builder::messages.create_new_menu")</a>.
                                    </span>
                                </form>
                            </div>
                                                                ...
                                                                <p id="menu-item-name-wrap">
                                                                    <label class="howto" for="custom-menu-item-name">
                                                                        ...
                                                                        <input id="custom-menu-item-name" name="label"
                                                                            ...
                                                                            title="@lang("
                                                                            menu-builder::messages.menu_label")">
                                                                    </label>
                                                                </p>
                                                                ...
                                                                <p id="menu-item-role_id-wrap">
                                                                    <label class="howto" for="custom-menu-item-name">
                                                                        ...
                                                                        <select id="custom-menu-item-role" name="role">
                                                                            <option value="0">
                                                                                @lang("menu-builder::messages.select_role")
                                                                            </option>
