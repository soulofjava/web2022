...
<link rel="apple-touch-icon" sizes="76x76" href="{{ route('helper.show-picture', ['path' => $data_website->favicon]) }}" />
<link rel="icon" type="image/png" href="{{ route('helper.show-picture', ['path' => $data_website->favicon]) }}" />
@else
<link rel="apple-touch-icon" sizes="76x76" href="{{ route('helper.show-picture', ['path' => $data_website->favicon]) }}" />
<link rel="icon" type="image/png" href="{{ route('helper.show-picture', ['path' => $data_website->favicon]) }}" />
@endif
