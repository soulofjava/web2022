        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            <div class="app-brand demo">
                    <a href="{{ url('/') }}" target="_blank" class="app-brand-link">
                        <img src="https://website.wonosobokab.go.id/assets/pemda.ico" alt="logo" style="width: 80px; display: block; margin-left: 60px;">
            ...
            <ul class="menu-inner py-1">
                ...
                @foreach(App\Models\Component::whereIn('name', ['agenda', 'download area', 'pinjam
                tempat'])->where('active', '1')->get() as $component)
                ...
                <li
                    class="menu-item {{ (Str::contains(Request::url(), ['faq', 'kategori', 'component', 'frontmenu', 'relatedlink', 'settings', 'user', 'myprofile'])) ? 'active open' : '' }}">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item {{ (Str::contains(Request::url(), 'faq')) ? 'active' : '' }}">
                        ...
                        <li
                            class="menu-item {{ (Str::contains(Request::url(), 'user') || Str::contains(Request::url(), 'myprofile')) ? 'active' : '' }}">
